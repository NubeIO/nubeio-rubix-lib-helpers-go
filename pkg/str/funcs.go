...
// StringManipulation is an interface that holds all abstract methods to manipulate str
...
// ToCamelCase is variadic function which takes one Param rule i.e slice of str and it returns
